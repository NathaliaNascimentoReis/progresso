...
('Escova Secadora Titanium', 'Britânia', 199.90, 'Cabelo', 550),
('Paleta de Sombras Neutras Urban', 'Huda Beauty', 389.90, 'Maquiagem', 400),
('Loção Hidratante Corporal CeraVe', 'CeraVe', 85.50, 'Skincare', 1100),
('Perfume 212 VIP Rosé Eau de Parfum', 'Carolina Herrera', 499.00, 'Perfumes', 980),
('Máscara de LED Facial para Acne', 'Dr. Face', 799.90, 'Skincare', 250);